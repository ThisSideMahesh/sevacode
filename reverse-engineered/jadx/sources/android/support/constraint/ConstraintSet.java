...
public class ConstraintSet {
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            this.mConstraints.put(num, constraintSet.mConstraints.get(num).m1clone());
        }
    }
    ...
    void applyToInternal(ConstraintLayout constraintLayout) {
        ...
        for (Integer num : hashSet) {
            ...
            if (constraint2.mIsGuideline) {
                ...
                constraintLayout.addView(guideline, layoutParamsGenerateDefaultLayoutParams);
            }
        }
    }
