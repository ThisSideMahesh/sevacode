...
public class ConstraintLayout extends ViewGroup {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (Build.VERSION.SDK_INT >= 11) {
            int iResolveSizeAndState = resolveSizeAndState(width, i, i4);
            int iResolveSizeAndState2 = resolveSizeAndState(height, i2, i4 << 16);
            int iMin = Math.min(this.mMaxWidth, iResolveSizeAndState);
            int iMin2 = Math.min(this.mMaxHeight, iResolveSizeAndState2);
            int i5 = iMin & ViewCompat.MEASURED_SIZE_MASK;
            int i6 = iMin2 & ViewCompat.MEASURED_SIZE_MASK;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            LayoutParams layoutParams = (LayoutParams) childAt.getLayoutParams();
            if (childAt.getVisibility() != 8 || layoutParams.isGuideline || zIsInEditMode) {
                ConstraintWidget constraintWidget = layoutParams.widget;
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                if (index == R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toLeftOf) {
                    int resourceId = typedArrayObtainStyledAttributes.getResourceId(index, this.leftToLeft);
                    ...
                    int resourceId2 = typedArrayObtainStyledAttributes.getResourceId(index, this.leftToRight);
                    ...
                    int resourceId3 = typedArrayObtainStyledAttributes.getResourceId(index, this.rightToLeft);
                    ...
                    int resourceId4 = typedArrayObtainStyledAttributes.getResourceId(index, this.rightToRight);
                    ...
                    int resourceId5 = typedArrayObtainStyledAttributes.getResourceId(index, this.topToTop);
                    ...
                    int resourceId6 = typedArrayObtainStyledAttributes.getResourceId(index, this.topToBottom);
                    ...
                    int resourceId7 = typedArrayObtainStyledAttributes.getResourceId(index, this.bottomToTop);
                    ...
                    int resourceId8 = typedArrayObtainStyledAttributes.getResourceId(index, this.bottomToBottom);
                    ...
                    int resourceId9 = typedArrayObtainStyledAttributes.getResourceId(index, this.baselineToBaseline);
                    ...
                    int resourceId10 = typedArrayObtainStyledAttributes.getResourceId(index, this.startToEnd);
                    ...
                    int resourceId11 = typedArrayObtainStyledAttributes.getResourceId(index, this.startToStart);
                    ...
                    int resourceId12 = typedArrayObtainStyledAttributes.getResourceId(index, this.endToStart);
                    ...
                    int resourceId13 = typedArrayObtainStyledAttributes.getResourceId(index, this.endToEnd);
                    ...
                    this.horizontalWeight = typedArrayObtainStyledAttributes.getFloat(index, 0.0f);
                } else if (index == R.styleable.ConstraintLayout_Layout_layout_constraintVertical_weight) {
                    this.verticalWeight = typedArrayObtainStyledAttributes.getFloat(index, 0.0f);
