...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        float f = 0.0f;
        int i9 = i7;
        assignSpans(recycler, state, i7, i6, z3);
        int i10 = 0;
        ...
        for (int i13 = 0; i13 < i9; i13++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i10) {
                ...
                if (this.mOrientation == 1) {
                    ...
                    childMeasureSpec = View.MeasureSpec.makeMeasureSpec(i10 - i14, 1073741824);
                } else {
        ...
        if (this.mOrientation == 1) {
            if (layoutState.mLayoutDirection == -1) {
                ...
                decoratedMeasurementInOther = i3 + i10;
                i2 = 0;
                i = 0;
            }
        } else {
        ...
        while (i16 < i9) {
            ...
            if (this.mOrientation == 1) {
                ...
                decoratedMeasurementInOther3 = i;
                decoratedMeasurementInOther = this.mOrientationHelper.getDecoratedMeasurementInOther(view4) + paddingTop;
            }
            layoutDecoratedWithMargins(view4, decoratedMeasurementInOther2, i4, decoratedMeasurementInOther3, decoratedMeasurementInOther);
            ...
            i = decoratedMeasurementInOther3;
            i3 = i4;
        }
    ...
    public static abstract class SpanSizeLookup {
        ...
        /* JADX WARN: Code duplicated, block: B:17:0x0033 A[DONT_INVERT] */
