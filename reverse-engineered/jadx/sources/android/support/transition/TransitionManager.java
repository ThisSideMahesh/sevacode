...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        transitionMo2clone.setSceneRoot(sceneRoot);
        Scene currentScene = Scene.getCurrentScene(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo2clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo2clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo2clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo2clone = transition.mo2clone();
        sceneChangeSetup(viewGroup, transitionMo2clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo2clone);
    }
