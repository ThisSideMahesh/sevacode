...
public class AnimatorInflaterCompat {
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            Object value = "null";
            StringBuilder sbAppend = new StringBuilder().append("Keyframe ").append(i).append(": fraction ").append(keyframe.getFraction() < 0.0f ? "null" : Float.valueOf(keyframe.getFraction())).append(", ").append(", value : ");
