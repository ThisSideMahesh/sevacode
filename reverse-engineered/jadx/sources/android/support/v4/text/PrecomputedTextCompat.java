    ...
    private int findParaIndex(int i) {
        ...
        while (true) {
            ...
            if (i2 < iArr.length) {
                ...
                StringBuilder sbAppend = new StringBuilder().append("pos must be less than ");
                int[] iArr2 = this.mParagraphEnds;
                throw new IndexOutOfBoundsException(sbAppend.append(iArr2[iArr2.length - 1]).append(", gave ").append(i).toString());
            }
        }
    }
