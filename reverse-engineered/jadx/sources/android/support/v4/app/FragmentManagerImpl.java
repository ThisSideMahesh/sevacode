...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    /* JADX WARN: Code duplicated, block: B:132:0x02c1  */
    ...
    /* JADX WARN: Code duplicated, block: B:191:0x03e7  */
    /* JADX WARN: Code duplicated, block: B:193:0x03eb  */
    /* JADX WARN: Code duplicated, block: B:195:0x03f1  */
    /* JADX WARN: Code duplicated, block: B:196:0x03fc  */
    /* JADX WARN: Code duplicated, block: B:198:0x0402  */
    /* JADX WARN: Code duplicated, block: B:221:0x0460  */
        ...
        if (fragment.mState <= i6) {
            ...
            if (fragment.mState > i6) {
                ...
                if (i8 != 1) {
                    ...
                    if (this.mDestroyed) {
                        if (fragment.getAnimatingAway() != null) {
                            View animatingAway2 = fragment.getAnimatingAway();
                            fragment.setAnimatingAway(null);
                            animatingAway2.clearAnimation();
                        } else if (fragment.getAnimator() != null) {
    ...
    public int allocBackStackIndex(BackStackRecord backStackRecord) {
        synchronized (this) {
            ...
            if (arrayList != null && arrayList.size() > 0) {
                ...
                int iIntValue = arrayList2.remove(arrayList2.size() - 1).intValue();
                if (DEBUG) {
