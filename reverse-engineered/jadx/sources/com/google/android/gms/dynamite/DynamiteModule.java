...
public final class DynamiteModule {
    ...
    private static int zzc(Context context, String str, boolean z) throws Throwable {
        ...
        try {
            ...
            Cursor cursorQuery = contentResolver.query(Uri.parse(new StringBuilder(str2.length() + 42 + String.valueOf(str).length()).append("content://com.google.android.gms.chimera/").append(str2).append("/").append(str).toString()), null, null, null, null);
            if (cursorQuery != null) {
                try {
