...
public class FirebaseApp {
    ...
    public static FirebaseApp getInstance(String str) {
        ...
        synchronized (zzg) {
            ...
            if (firebaseApp == null) {
                ...
                throw new IllegalStateException(String.format("FirebaseApp with name %s doesn't exist. %s", str, listZzd.isEmpty() ? "" : "Available app names: " + TextUtils.join(", ", listZzd)));
            }
        }
        return firebaseApp;
    }
    ...
    public static FirebaseApp initializeApp(Context context, FirebaseOptions firebaseOptions, String str) {
        ...
        synchronized (zzg) {
            ...
            Preconditions.checkState(!map.containsKey(strTrim), "FirebaseApp name " + strTrim + " already exists!");
            Preconditions.checkNotNull(context, "Application context cannot be null.");
            firebaseApp = new FirebaseApp(context, strTrim, firebaseOptions);
            map.put(strTrim, firebaseApp);
        }
        firebaseApp.zze();
        return firebaseApp;
    }
