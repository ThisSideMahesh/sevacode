...
public class SliderPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new Comparator<ItemInfo>() { // from class: com.dp.sgp.autoimageslider.SliderPager.1
        @Override // java.util.Comparator
        public int compare(ItemInfo itemInfo, ItemInfo itemInfo2) {
            return itemInfo.position - itemInfo2.position;
        }
    };
    private static final Interpolator sInterpolator = new Interpolator() { // from class: com.dp.sgp.autoimageslider.SliderPager.2
    ...
    public SliderPager(Context context) {
        ...
        this.mEndScrollRunnable = new Runnable() { // from class: com.dp.sgp.autoimageslider.SliderPager.3
    ...
    void initSliderPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() { // from class: com.dp.sgp.autoimageslider.SliderPager.4
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                ...
                for (int i = 0; i < childCount; i++) {
                    WindowInsetsCompat windowInsetsCompatDispatchApplyWindowInsets = ViewCompat.dispatchApplyWindowInsets(SliderPager.this.getChildAt(i), windowInsetsCompatOnApplyWindowInsets);
    ...
    private void setAdapterViewPagerObserver(PagerObserver pagerObserver) {
        try {
            ...
            declaredMethod.invoke(this.mAdapter, pagerObserver);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void triggerOnPageChangeEvent(int i) {
        for (OnPageChangeListener onPageChangeListener : this.mOnPageChangeListeners) {
            if (onPageChangeListener != null) {
                PagerAdapter pagerAdapter = this.mAdapter;
                if (pagerAdapter instanceof InfinitePagerAdapter) {
                    onPageChangeListener.onPageSelected(((InfinitePagerAdapter) pagerAdapter).getRealPosition(i));
                } else {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: com.dp.sgp.autoimageslider.SliderPager.SavedState.1
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            this.widthFactor = 0.0f;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, SliderPager.LAYOUT_ATTRS);
