...
public class ProductVideoAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ProductVideoAdapter(List<CommonData> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        ...
        Glide.with(this.context).load(this.list.get(i).getThumb_image()).apply(requestOptions).listener(new RequestListener<Drawable>() { // from class: com.dp.sgp.Adapters.ProductVideoAdapter.1
