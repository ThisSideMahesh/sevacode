...
public class NewProductAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public NewProductAdapter(List<Youtube> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(this.context).inflate(R.layout.new_upakram_row, viewGroup, false));
    }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        ...
        Glide.with(this.context).load(this.list.get(i).getImage()).apply(requestOptions).listener(new RequestListener<Drawable>() { // from class: com.dp.sgp.Adapters.NewProductAdapter.1
        ...
        }).transition(DrawableTransitionOptions.withCrossFade()).into(viewHolder.title_lag);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            this.textViewAndroid = (TextView) view.findViewById(R.id.title);
            this.title_lag = (ImageView) view.findViewById(R.id.title_lag);
        }
    }
}
