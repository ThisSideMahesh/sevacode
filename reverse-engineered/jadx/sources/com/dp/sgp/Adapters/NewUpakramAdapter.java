...
public class NewUpakramAdapter extends BaseAdapter {
    ...
    public NewUpakramAdapter(Context context, String[] strArr, int[] iArr) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View viewInflate = layoutInflater.inflate(R.layout.new_upakram_row, (ViewGroup) null);
