...
public class OfflineSwamiCharitraAdapter extends RecyclerView.Adapter<MyViewHolder> {
    private Context mContext;
    private List<DBSwamiDatum> swamiCharitraModelList;
    ...
    public OfflineSwamiCharitraAdapter(Context context, List<DBSwamiDatum> list) {
    ...
    public void onBindViewHolder(MyViewHolder myViewHolder, int i) {
        DBSwamiDatum dBSwamiDatum = this.swamiCharitraModelList.get(i);
        myViewHolder.title.setText(dBSwamiDatum.getTitle());
        myViewHolder.txt_count.setText((i + 1) + "");
        myViewHolder.txt_date.setText(dBSwamiDatum.getCompleted_on());
        if (dBSwamiDatum.getStatus().equalsIgnoreCase("1")) {
        ...
        } else if (dBSwamiDatum.getStatus().equalsIgnoreCase("2")) {
            myViewHolder.txt_count.setTextColor(Color.parseColor(ColorAnimation.DEFAULT_SELECTED_COLOR));
            myViewHolder.title.setTextColor(Color.parseColor("#302165"));
