...
public class NityaSevaGridViewAdapter extends BaseAdapter {
    ...
    public NityaSevaGridViewAdapter(Context context, String[] strArr, int[] iArr) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View viewInflate = layoutInflater.inflate(R.layout.nityaseva_row, (ViewGroup) null);
