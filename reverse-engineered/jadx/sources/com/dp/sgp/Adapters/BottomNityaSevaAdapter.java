...
public class BottomNityaSevaAdapter extends BaseAdapter {
    ...
    public BottomNityaSevaAdapter(Context context, String[] strArr, int[] iArr) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View viewInflate = layoutInflater.inflate(R.layout.bottom_nityaseva_row, (ViewGroup) null);
