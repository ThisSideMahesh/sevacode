...
public class NewVibhagAdapter extends RecyclerView.Adapter<ViewHolder> {
    Context context;
    List<Vibhag> list;

    public NewVibhagAdapter(List<Vibhag> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(this.context).inflate(R.layout.followers_card, viewGroup, false));
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        Glide.with(this.context).load(this.list.get(i).getThumb_image()).apply(requestOptions).listener(new RequestListener<Drawable>() { // from class: com.dp.sgp.Adapters.NewVibhagAdapter.1
