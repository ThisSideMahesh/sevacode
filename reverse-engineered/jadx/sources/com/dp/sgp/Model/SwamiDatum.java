...
public class SwamiDatum implements Parcelable {
    public static final Parcelable.Creator<SwamiDatum> CREATOR = new Parcelable.Creator<SwamiDatum>() { // from class: com.dp.sgp.Model.SwamiDatum.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public SwamiDatum createFromParcel(Parcel parcel) {
            return new SwamiDatum(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public SwamiDatum[] newArray(int i) {
            return new SwamiDatum[i];
        }
    };
    ...
    protected SwamiDatum(Parcel parcel) {
